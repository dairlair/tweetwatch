...
func configureAPI(api *operations.TweetwatchAPI) http.Handler {
	...
	if api.CreateStreamHandler == nil {
		api.CreateStreamHandler = operations.CreateStreamHandlerFunc(func(params operations.CreateStreamParams, principal *models.User) middleware.Responder {
	...
	if api.DeleteTopicHandler == nil {
		api.DeleteTopicHandler = operations.DeleteTopicHandlerFunc(func(params operations.DeleteTopicParams, principal *models.User) middleware.Responder {
	...
	if api.GetTopicTweetsHandler == nil {
		api.GetTopicTweetsHandler = operations.GetTopicTweetsHandlerFunc(func(params operations.GetTopicTweetsParams, principal *models.User) middleware.Responder {
